...
<i><u>@Description</u></i>: $(cat ./BINARY_NAME) is a simple tool that allow the user to     specify a list of  
applications/tasks to monitor, thus the user can see how much time he/she      spends on them.
